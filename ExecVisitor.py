...
class ExecVisitor(GraphVisitor):
    ...
    def visitBuiltinColor(self, ctx):
        self.color = ctx.C.text
        return f"Color: {self.color}"
    
    def visitCustomColor(self, ctx):
